...
func NewUserGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("pocket-id:index:UserGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserGroup(ctx *pulumi.Context,
	...
	var resource UserGroup
	err := ctx.ReadResource("pocket-id:index:UserGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o UserGroupOutput) FriendlyName() pulumi.StringOutput {
	return o.ApplyT(func(v *UserGroup) pulumi.StringOutput { return v.FriendlyName }).(pulumi.StringOutput)
}
