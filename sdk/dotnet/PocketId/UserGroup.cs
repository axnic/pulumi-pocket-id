...
{
    [PocketIdResourceType("pocket-id:index:UserGroup")]
    public partial class UserGroup : global::Pulumi.CustomResource
    {
        ...
        public UserGroup(string name, UserGroupArgs args, CustomResourceOptions? options = null)
            : base("pocket-id:index:UserGroup", name, args ?? new UserGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserGroup(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("pocket-id:index:UserGroup", name, null, MakeResourceOptions(options, id))
        {
        }
