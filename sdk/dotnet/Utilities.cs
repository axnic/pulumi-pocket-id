...
namespace Axnic.Pulumi.PocketId
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/axnic/pulumi-pocket-id";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Axnic.Pulumi.PocketId.version.txt");
    ...
    internal sealed class PocketIdResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PocketIdResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
